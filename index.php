...
<!--        <script type="text/javascript" src="./unit-test/uploadPages/scripts/jquery.min.js"></script>
        ...
        <script src="../utility/lib/lib-Highcharts/js/highcharts.js"></script>
...
<!--                <li><a href="./page1.php">Link page1</a></li>-->
                ...
                <!-- <li><a  href="#chart_show_plotArea" >ทดสอบ</a></li> -->
            </ul>      
...
<!-- Year Folder : Start here -->
        <div id="chart_show_plotArea"  class="panel" style="height: 100%" otherButtonLabel="HOME" otherButtonHref="javascript:showPage_byID('menu')" otherButtonClass="blueButton">
            <h2>รายการเมนู</h2>
            <div id="chart_container" style="height: 89%; width: 99%"></div>
        </div>
<!-- Year Folder : End here -->
